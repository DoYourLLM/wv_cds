...
say ""
say "   Still to do by hand: set the waveform file in"
say "       $SKILL/wv_cds_config.il"
say "   (WV_CDS_FSDB), or leave it empty and fill the Python GUI's Config"
say "   box, then press Save - that rewrites the same line for you."
say ""
